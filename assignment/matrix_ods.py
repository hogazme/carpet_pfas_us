...
def osm_processing(socio_gdf, afc_shp):
    socio_gdf['ct_x'] = socio_gdf['geometry'].centroid.x
    socio_gdf['ct_y'] = socio_gdf['geometry'].centroid.y
    socio_gdf_sub = socio_gdf[['GEOID', 'ct_x', 'ct_y']]
    afc_shp_sub = afc_shp[['facility_id', 'facility_x', 'facility_y']]
    od_marix = generate_od_df(socio_gdf, afc_shp)
